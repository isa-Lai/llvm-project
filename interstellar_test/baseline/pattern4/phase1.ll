...
entry:
  ...
  call void @llvm.interstellar.configure.loop(i32 3, i32 0, i1 false, i1 true, i32 0, i32 0, i32 1)
  call void @llvm.interstellar.configure.directstream(i32 4, i32 3, i1 true, ptr inttoptr (i64 1 to ptr), i32 4)
  call void @llvm.interstellar.configure.indirectstream(i32 5, i32 0, i1 true, ptr inttoptr (i64 2 to ptr), i32 12, i32 0)
  call void @llvm.interstellar.configure.indirectstream(i32 6, i32 0, i1 true, ptr inttoptr (i64 2 to ptr), i32 12, i32 0)
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %state.0 = phi i32 [ 305419896, %entry ], [ %add8, %for.inc ]
...
if.then:                                          ; preds = %land.lhs.true
  ...
  store i32 %add, ptr %x, align 4, !tbaa !14
  %idxprom5 = sext i32 %1 to i64
  %arrayidx6 = getelementptr inbounds %struct.Point, ptr %points, i64 %idxprom5
  %y = getelementptr inbounds nuw %struct.Point, ptr %arrayidx6, i32 0, i32 1
  %3 = load i32, ptr %y, align 4, !tbaa !16
  %add7 = add nsw i32 %3, 20
  store i32 %add7, ptr %y, align 4, !tbaa !16
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %for.body
  %mul = mul i32 %state.0, 1664525
  %add8 = add i32 %mul, 1013904223
  %rem = urem i32 %add8, %N
  %idxprom9 = sext i32 %rem to i64
  %arrayidx10 = getelementptr inbounds %struct.Point, ptr %points, i64 %idxprom9
  %z = getelementptr inbounds nuw %struct.Point, ptr %arrayidx10, i32 0, i32 2
  %4 = load i32, ptr %z, align 4, !tbaa !17
  %add11 = add nsw i32 %4, 100
  store i32 %add11, ptr %z, align 4, !tbaa !17
  br label %for.inc
