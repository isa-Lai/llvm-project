; ModuleID = 'pattern3_struct_direct.c'
...
entry:
  ...
  store ptr %points, ptr %points.addr, align 8, !tbaa !13
...
for.body:                                         ; preds = %for.cond
  %2 = load ptr, ptr %points.addr, align 8, !tbaa !13
  ...
  %4 = load i32, ptr %x, align 4, !tbaa !17
  %inc = add nsw i32 %4, 1
  store i32 %inc, ptr %x, align 4, !tbaa !17
  %5 = load ptr, ptr %points.addr, align 8, !tbaa !13
  %6 = load i32, ptr %i, align 4, !tbaa !16
  %idxprom1 = sext i32 %6 to i64
  %arrayidx2 = getelementptr inbounds %struct.Point, ptr %5, i64 %idxprom1
  %y = getelementptr inbounds nuw %struct.Point, ptr %arrayidx2, i32 0, i32 1
  %7 = load i32, ptr %y, align 4, !tbaa !19
  %add = add nsw i32 %7, 2
  store i32 %add, ptr %y, align 4, !tbaa !19
  %8 = load ptr, ptr %points.addr, align 8, !tbaa !13
  ...
  %10 = load i32, ptr %z, align 4, !tbaa !20
  %add5 = add nsw i32 %10, 3
  store i32 %add5, ptr %z, align 4, !tbaa !20
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %11 = load i32, ptr %i, align 4, !tbaa !16
  %inc6 = add nsw i32 %11, 1
  store i32 %inc6, ptr %i, align 4, !tbaa !16
...
entry:
  ...
  store ptr %call, ptr %points1, align 8, !tbaa !13
  %1 = load ptr, ptr %points1, align 8, !tbaa !13
  %2 = load i32, ptr %N1, align 4, !tbaa !16
  call void @pattern3_struct_direct(ptr noundef %1, i32 noundef signext %2)
  %3 = load ptr, ptr %points1, align 8, !tbaa !13
  ...
  %4 = load i32, ptr %N2, align 4, !tbaa !16
  %conv1 = sext i32 %4 to i64
  %call2 = call noalias ptr @calloc(i64 noundef %conv1, i64 noundef 12) #5
  store ptr %call2, ptr %points2, align 8, !tbaa !13
  %5 = load ptr, ptr %points2, align 8, !tbaa !13
  %6 = load i32, ptr %N2, align 4, !tbaa !16
  call void @pattern3_struct_direct(ptr noundef %5, i32 noundef signext %6)
  %7 = load ptr, ptr %points2, align 8, !tbaa !13
...
!12 = !{!"Simple C/C++ TBAA"}
!13 = !{!14, !14, i64 0}
!14 = !{!"p1 _ZTS5Point", !15, i64 0}
!15 = !{!"any pointer", !11, i64 0}
!16 = !{!10, !10, i64 0}
!17 = !{!18, !10, i64 0}
!18 = !{!"Point", !10, i64 0, !10, i64 4, !10, i64 8}
!19 = !{!18, !10, i64 4}
!20 = !{!18, !10, i64 8}
