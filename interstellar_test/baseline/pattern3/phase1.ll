...
source_filename = "pattern3_struct_direct.c"
...
define dso_local void @pattern3_struct_direct(ptr noundef %points, i32 noundef signext %N) #0 {
entry:
  %scevgep = getelementptr i8, ptr %points, i64 8
  %scevgep1 = getelementptr i8, ptr %points, i64 16
  call void @llvm.interstellar.configure.link(i32 1, ptr %points, i32 8)
  ...
  call void @llvm.interstellar.configure.directstream(i32 5, i32 4, i1 true, ptr inttoptr (i64 1 to ptr), i32 12)
  call void @llvm.interstellar.configure.directstream(i32 6, i32 4, i1 true, ptr inttoptr (i64 2 to ptr), i32 12)
  call void @llvm.interstellar.configure.directstream(i32 7, i32 4, i1 true, ptr inttoptr (i64 3 to ptr), i32 12)
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds %struct.Point, ptr %points, i64 %idxprom
  %x = getelementptr inbounds nuw %struct.Point, ptr %arrayidx, i32 0, i32 0
  %1 = load i32, ptr %x, align 4, !tbaa !13
  %inc = add nsw i32 %1, 1
  store i32 %inc, ptr %x, align 4, !tbaa !13
  %idxprom1 = sext i32 %i.0 to i64
  %arrayidx2 = getelementptr inbounds %struct.Point, ptr %points, i64 %idxprom1
  %y = getelementptr inbounds nuw %struct.Point, ptr %arrayidx2, i32 0, i32 1
  %2 = load i32, ptr %y, align 4, !tbaa !15
  %add = add nsw i32 %2, 2
  store i32 %add, ptr %y, align 4, !tbaa !15
  %idxprom3 = sext i32 %i.0 to i64
  %arrayidx4 = getelementptr inbounds %struct.Point, ptr %points, i64 %idxprom3
  %z = getelementptr inbounds nuw %struct.Point, ptr %arrayidx4, i32 0, i32 2
  %3 = load i32, ptr %z, align 4, !tbaa !16
  %add5 = add nsw i32 %3, 3
  store i32 %add5, ptr %z, align 4, !tbaa !16
  br label %for.inc
...
entry:
  ...
  %call = call noalias ptr @calloc(i64 noundef %conv, i64 noundef 12) #5
  call void @pattern3_struct_direct(ptr noundef %call, i32 noundef signext 50)
  call void @free(ptr noundef %call) #6
  %conv1 = sext i32 100 to i64
  %call2 = call noalias ptr @calloc(i64 noundef %conv1, i64 noundef 12) #5
  call void @pattern3_struct_direct(ptr noundef %call2, i32 noundef signext 100)
...
!12 = !{!"Simple C/C++ TBAA"}
!13 = !{!14, !10, i64 0}
!14 = !{!"Point", !10, i64 0, !10, i64 4, !10, i64 8}
!15 = !{!14, !10, i64 4}
!16 = !{!14, !10, i64 8}
