; ModuleID = 'patternC_array_bounded_indirect.c'
source_filename = "patternC_array_bounded_indirect.c"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-linux-gnu"

@A = dso_local global [1024 x i32] zeroinitializer, align 4
@B = dso_local global [1024 x i32] zeroinitializer, align 4
@Out = dso_local global [1024 x i32] zeroinitializer, align 4

; Function Attrs: nounwind uwtable
define dso_local void @gather() #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [1024 x i32], ptr @B, i64 0, i64 %idxprom
  %2 = load i32, ptr %arrayidx, align 4, !tbaa !13
  %idxprom1 = sext i32 %2 to i64
  %arrayidx2 = getelementptr inbounds [1024 x i32], ptr @A, i64 0, i64 %idxprom1
  %3 = load i32, ptr %arrayidx2, align 4, !tbaa !13
  %4 = load i32, ptr %i, align 4, !tbaa !13
  %idxprom3 = sext i32 %4 to i64
  %arrayidx4 = getelementptr inbounds [1024 x i32], ptr @Out, i64 0, i64 %idxprom3
