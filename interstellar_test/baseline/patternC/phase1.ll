...
entry:
  call void @llvm.interstellar.configure.loop(i32 0, i32 0, i1 false, i1 false, i32 0, i32 1024, i32 1)
  call void @llvm.interstellar.configure.directstream(i32 1, i32 0, i1 false, ptr @B, i32 4)
  call void @llvm.interstellar.configure.directstream(i32 2, i32 0, i1 false, ptr @Out, i32 4)
  call void @llvm.interstellar.configure.indirectstream(i32 3, i32 0, i1 false, ptr @A, i32 4, i32 4096)
  br label %for.cond
