...
entry:
  ...
  call void @llvm.interstellar.configure.link(i32 2, ptr %B, i32 8)
  ...
  call void @llvm.interstellar.configure.indirectstream(i32 5, i32 0, i1 true, ptr inttoptr (i64 2 to ptr), i32 4, i32 0)
  call void @llvm.interstellar.configure.indirectstream(i32 6, i32 0, i1 true, ptr inttoptr (i64 2 to ptr), i32 4, i32 0)
  br label %for.cond
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %arrayidx4 = getelementptr inbounds i32, ptr %B, i64 %idxprom3
  %2 = load i32, ptr %arrayidx4, align 4, !tbaa !13
  %inc = add nsw i32 %2, 1
  store i32 %inc, ptr %arrayidx4, align 4, !tbaa !13
  br label %if.end
...
if.end:                                           ; preds = %if.then, %land.lhs.true, %for.body
  ...
  store i32 %inc7, ptr %arrayidx6, align 4, !tbaa !13
  br label %for.inc
...
entry:
  ...
  call void @pattern2_indirect_streams(ptr noundef %call, ptr noundef %call2, i32 noundef signext 50)
  call void @free(ptr noundef %call) #5
  call void @free(ptr noundef %call2) #5
  %conv3 = sext i32 100 to i64
  ...
  call void @pattern2_indirect_streams(ptr noundef %call4, ptr noundef %call6, i32 noundef signext 100)
  call void @free(ptr noundef %call4) #5
  call void @free(ptr noundef %call6) #5
  ret i32 0
}
