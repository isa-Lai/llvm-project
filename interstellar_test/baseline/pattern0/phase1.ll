...
source_filename = "pattern0_simple.c"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64-unknown-linux-gnu"

; Function Attrs: nounwind uwtable
define dso_local void @test(ptr noundef %A, ptr noundef %B, i32 noundef signext %N) #0 {
entry:
  ...
  call void @llvm.interstellar.configure.directstream(i32 5, i32 3, i1 true, ptr inttoptr (i64 2 to ptr), i32 4)
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  store i32 %mul, ptr %arrayidx2, align 4, !tbaa !13
  br label %for.inc
